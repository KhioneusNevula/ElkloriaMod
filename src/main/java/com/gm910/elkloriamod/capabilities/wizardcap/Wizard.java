package com.gm910.elkloriamod.capabilities.wizardcap;

import com.gm910.elkloriamod.Elkloria;
import com.gm910.elkloriamod.damage.MagicDamage;
...
public class Wizard implements IWizard {
	...
	public static final ResourceLocation LOC = new ResourceLocation(Elkloria.MODID, "wizardcap");
