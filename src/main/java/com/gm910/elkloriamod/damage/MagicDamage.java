package com.gm910.elkloriamod.damage;
...
public class MagicDamage extends EntityDamageSource {
	...
	public ITextComponent getDeathMessage(LivingEntity base) {
		...
		return Translate.make("message.magicdeath." + (super.getTrueSource() == null ? "fromnone" : "fromwiz"), base.getDisplayName(), getTrueSource().getDisplayName());
	}
