...
public class UsifiaBiomeProvider extends BiomeProvider {
	...
	static {
		...
		ImmutableSet<Biome> imset = ModReflect.getField(OverworldBiomeProvider.class, ImmutableSet.class, "field_226847_e_", null);
