...
public class UsifiaDimension extends Dimension {

	public UsifiaDimension(World world, DimensionType type) {
	...
	public ChunkGenerator<?> createChunkGenerator() {
		return new UsifiaChunkGenerator(world, new UsifiaBiomeProvider(), new UsifiaGenSettings());
	}
