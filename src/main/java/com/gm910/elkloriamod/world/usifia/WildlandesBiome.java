 ...
 * 
 */
package com.gm910.elkloriamod.world.usifia;

import java.awt.Color;

import com.gm910.elkloriamod.api.util.Translate;
 ...
 *
 */
public class WildlandesBiome extends Biome {

	public WildlandesBiome() {
		super(new Biome.Builder().category(Biome.Category.NETHER).waterColor(0x000000).waterFogColor(0x000000));
	...
	public ITextComponent getDisplayName() {
		// TODO Auto-generated method stub
		return Translate.make("biome.wildlandes");
	}
