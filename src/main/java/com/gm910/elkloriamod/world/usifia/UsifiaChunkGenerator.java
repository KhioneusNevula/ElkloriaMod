...
public class UsifiaChunkGenerator extends NoiseChunkGenerator<UsifiaGenSettings> {
  ...
  public UsifiaChunkGenerator(IWorld worldIn, BiomeProvider provider, UsifiaGenSettings settingsIn) {
